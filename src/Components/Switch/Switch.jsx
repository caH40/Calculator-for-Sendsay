...
const Switch = () => {
	return (
		<div className={cls.wrapper}>
			<div className={`${cls.box} ${cls.box__left}`}>
				<svg
					className={cls.icon}
					width="18"
					height="14"
				...
				<span className={cls.text}>Runtime</span>
			</div>

			<div className={`${cls.box} ${cls.box__right} ${cls.active}`}>
				<svg
					className={cls.icon}
					width="14"
					height="10"
				...
				<span className={cls.text}>Constructor</span>
			</div>
		</div>
	);
};
